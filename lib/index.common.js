...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_v16_dist_index_js_ref_0_1_interModel_vue_vue_type_style_index_0_id_033b4203_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("d5ab");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_v16_dist_index_js_ref_0_1_interModel_vue_vue_type_style_index_0_id_033b4203_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_v16_dist_index_js_ref_0_1_interModel_vue_vue_type_style_index_0_id_033b4203_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_0__);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader-v16/dist/templateLoader.js??ref--6!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader-v16/dist??ref--0-1!./packages/interModel/src/interModel.vue?vue&type=template&id=033b4203&scoped=true


var _withId = /*#__PURE__*/Object(external_commonjs_vue_commonjs2_vue_root_Vue_["withScopeId"])("data-v-033b4203");

Object(external_commonjs_vue_commonjs2_vue_root_Vue_["pushScopeId"])("data-v-033b4203");
...
// CONCATENATED MODULE: ./packages/interModel/src/interModel.vue?vue&type=template&id=033b4203&scoped=true
    ...
    value: function calculation(prop) {
      ...
      switch (prop) {
        ...
        case 'point':
          ...
          var minY = this.point.AL.y < this.point.AR.y ? this.point.AL.y : this.point.AR.y;
          this.point.CL = {
            x: this.point.AL.x,
          ...
          var h = Math.min(this.point.AL.y, this.point.AR.y); // 记录原来的B点位 BLO  BRO
        ...
        case 'BToD':
          // eslint-disable-next-line no-case-declarations
          var angelA = 20; // eslint-disable-next-line no-case-declarations

          var createDRToBR = function createDRToBR() {
            var rightPoint = {
              x: _this2.point.AR.x + Math.cos(angleRight2) * (CrossConst.manRoadLength + CrossConst.manRadianLength),
              y: _this2.point.AR.y + Math.sin(angleRight2) * (CrossConst.manRoadLength + CrossConst.manRadianLength)
            };
            ...
            _this2.point.BToDR = [];
            _this2.point.B1ToD1R = [];
            var _this2$point$BR = _this2.point.BR,
                x1 = _this2$point$BR.x,
                y1 = _this2$point$BR.y;
            ...
            if (toRightAngle < 180 && _this2.entranceNum !== 2) {
            ...
            _this2.point.rightPoint = rightPoint;
            x1 += CrossConst.walkwayWidth;
            x3 = rightPoint.x;
            y3 = rightPoint.y;
            x2 = x1 + Math.cos(interModel_Util.toRadian(angelA + interModel_Util.toAngle(Math.atan((y3 - y1) / (x3 - x1))))) * Math.sqrt((y3 - y1) * (y3 - y1) + (x3 - x1) * (x3 - x1)) / 2 / Math.cos(interModel_Util.toRadian(angelA));
            y2 = y1 + Math.sin(interModel_Util.toRadian(angelA + interModel_Util.toAngle(Math.atan((y3 - y1) / (x3 - x1))))) * Math.sqrt((y3 - y1) * (y3 - y1) + (x3 - x1) * (x3 - x1)) / 2 / Math.cos(interModel_Util.toRadian(angelA));
            _this2.point.OOO = {
              x: x2,
              y: y2
            };
        ...
        case 'fdsplitLine':
          ...
          if (fdLaneNum > -1) {
            var _this$correctPoint$H = this.correctPoint.H0[this["in"] - fdLaneNum],
                x1 = _this$correctPoint$H.x,
                y1 = _this$correctPoint$H.y;
            var _this$correctPoint$H2 = this.correctPoint.H2[this["in"] - fdLaneNum],
                x2 = _this$correctPoint$H2.x,
                y2 = _this$correctPoint$H2.y;
  ...
  _createClass(CrossRampObject, [{
    ...
    value: function calculation(prop) {
      ...
      switch (prop) {
        case 'point':
          if (this.en_id === 1) {
            var _x3 = CrossConst.roadWidth * this.secondIn + dw;

            var x2 = CrossConst.roadWidth * (this.secondIn + this["in"]) + dw;

            var _y3 = this.clientHeight / 2;
            ...
            var _x4 = CrossConst.roadWidth * this["in"];

            var _y4 = this.clientHeight / 2;
            ...
            var _x5 = CrossConst.roadWidth * this["in"] / 2;

            var _y5 = CrossConst.roadWidth * this["in"] / 2 / Math.tan(this.angle * Math.PI / 180);
            ...
            this.point = {
              ...
              BL: {
                x: -_x5,
                y: -_y5 - CrossConst.defaultRoadLength
              },
              BR: {
                x: _x5,
                y: -_y5 - CrossConst.defaultRoadLength
  ...
  setup: function setup(props) {
    ...
    var methods = {
      ...
      drawInter: function drawInter(interData) {
        ...
        cross = new interModel_CrossInfo(drawInterData); // console.log(this.cross)
        // 根据数据绘画
    ...
    var drawRealMethods = {
        ...
        cross.entranceArray.forEach(function (it, i) {
          ...
          moveList.forEach(function (itt, j) {
            ...
            if (flow) {
              ...
              if (flow.enter_port_direction === it.en_id && flow.if_control && flow.fd_flow === fdFlow) {
                if (Number(itt) === type) {
                  list.push(flow.movements_type);
                }
              }
      ...
      getInterPhaseFlowColor: function getInterPhaseFlowColor(movements_state, movementParas, index, flowType, road_type) {
        ...
        movementParas.forEach(function (it) {
          if (it.if_control) {
            if (it.enter_port_direction === curEntrance.en_id && it.fd_flow === fdFlow) {
...
// EXTERNAL MODULE: ./packages/interModel/src/interModel.vue?vue&type=style&index=0&id=033b4203&scoped=true&lang=scss
var interModelvue_type_style_index_0_id_033b4203_scoped_true_lang_scss = __webpack_require__("c2ec");
...
interModelvue_type_script_lang_ts.__scopeId = "data-v-033b4203"
