...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_v16_dist_index_js_ref_0_1_interModel_vue_vue_type_style_index_0_id_53dddc24_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("3577");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_v16_dist_index_js_ref_0_1_interModel_vue_vue_type_style_index_0_id_53dddc24_lang_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_v16_dist_index_js_ref_0_1_interModel_vue_vue_type_style_index_0_id_53dddc24_lang_scss__WEBPACK_IMPORTED_MODULE_0__);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/vue-loader-v16/dist/templateLoader.js??ref--6!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader-v16/dist??ref--0-1!./packages/interModel/src/interModel.vue?vue&type=template&id=53dddc24
...
// CONCATENATED MODULE: ./packages/interModel/src/interModel.vue?vue&type=template&id=53dddc24
...
var RoadCenterMode = {
  ...
  greenArea: 'greenArea',
  singleYellowLine: 'singleYellowLine'
}; // 工具类
...
var interModel_CrossDirectionObject = /*#__PURE__*/function () {
  function CrossDirectionObject(param) {
    ...
    this.twice_crossing_street = option.twice_crossing_street; // 车道流向
...
function getInterPhaseflowData(flowType, entrance) {
  ...
  var motorWidth = CrossConst.roadWidth * entrance["in"];
  ...
  setup: function setup(props, _ref) {
    ...
    var methods = {
      ...
      drawInter: function drawInter(interData) {
        ...
        cross.entranceArray.map(function (info, index) {
          if (state.interType !== 2) {
            // 绘制右转渠化
            info.canalization && drawMethods.drawCanalization(info.en_id); // 二次过街绘制 安全岛

            info.twice_crossing_street && drawMethods.drawTwiceIsland(info.en_id); // 添加非机动车标志
    ...
    var drawMethods = {
      ...
      drawRoadFlow: function drawRoadFlow(movements, cb) {
        ...
        sortMovement.forEach(function (it, i) {
      ...
      drawFlowSaturation: function drawFlowSaturation(flowSaturation) {
        ...
        flowSaturation.forEach(function (it, i) {
          var enterInfo = cross.entranceArray[it.enter_port_direction - 1];
      ...
      // 绘制二次过街安全岛
      drawTwiceIsland: function drawTwiceIsland(en_id) {
        var index = en_id - 1;
        var curEntrance = cross.entranceArray[index]; // 获取绘制安全岛点位

        var y = curEntrance.point.H0[curEntrance["in"]].y;
        var greenWidth = CrossConst.greenWidth; // 绿化带宽度
        // const doubleYellowLineInterval = CrossConst.doubleYellowLineInterval // 双黄线宽度

        var manRoadLength = CrossConst.manRoadLength; // 双黄线宽度

        var manCarInterval = CrossConst.manCarInterval; // 双黄线宽度

        var points = [];
        var width = greenWidth; // 单黄线

        if (curEntrance.road_center_mode === "singleYellowLine") {// const { x: x, y: y } = Util.pointRotateAngel(topPoint, -curEntrance.angle)
        }
        ...
        var _Util$pointRotateAnge = interModel_Util.pointRotateAngel({
          x: -width,
          y: y + manCarInterval
        }, -curEntrance.angle),
            x1 = _Util$pointRotateAnge.x,
            y1 = _Util$pointRotateAnge.y;

        var _Util$pointRotateAnge2 = interModel_Util.pointRotateAngel({
          x: width,
          y: y + manCarInterval
        }, -curEntrance.angle),
            x2 = _Util$pointRotateAnge2.x,
            y2 = _Util$pointRotateAnge2.y;

        var _Util$pointRotateAnge3 = interModel_Util.pointRotateAngel({
          x: width,
          y: y + manCarInterval + manRoadLength
        }, -curEntrance.angle),
        ...
        var _Util$pointRotateAnge4 = interModel_Util.pointRotateAngel({
          ...
          y: y + manCarInterval + manRoadLength
            ...
            x4 = _Util$pointRotateAnge4.x,
            y4 = _Util$pointRotateAnge4.y;

        points.push([x1, y1]);
        points.push([x2, y2]);
        points.push([x3, y3]);
        points.push([x4, y4]);
        drawMethods.drawPolygon(points, {
          fill: "#2e8348",
          opacity: 0.8
        });
      },
      ...
      drawCanalization: function drawCanalization(en_id) {
        ...
        if (curEntrance.canalization === 1 || curEntrance.canalization === 2) {
          ...
          var _Util$pointRotateAnge5 = interModel_Util.pointRotateAngel(topPoint, -curEntrance.angle),
              x = _Util$pointRotateAnge5.x,
              y = _Util$pointRotateAnge5.y;

          var _Util$pointRotateAnge6 = interModel_Util.pointRotateAngel(bottomPoint, -curEntrance.angle),
              x1 = _Util$pointRotateAnge6.x,
              y1 = _Util$pointRotateAnge6.y;

          var _Util$pointRotateAnge7 = interModel_Util.pointRotateAngel(rightPoint, -rightEntrance.angle),
              x3 = _Util$pointRotateAnge7.x,
              y3 = _Util$pointRotateAnge7.y;
          ...
          var colPoints = offsetDistanceY.map(function (it, i) {
            ...
            var _Util$pointRotateAnge8 = interModel_Util.pointRotateAngel({
              ...
              y: cy + it
                ...
                x = _Util$pointRotateAnge8.x,
                y = _Util$pointRotateAnge8.y;
          ...
          var rowPoints = offsetDistanceY.map(function (it, i) {
            ...
            var _Util$pointRotateAnge9 = interModel_Util.pointRotateAngel({
              x: rx + 1 - itX,
              y: ry + it
            }, -rightEntrance.angle),
                x = _Util$pointRotateAnge9.x,
                y = _Util$pointRotateAnge9.y;
      ...
      drawRoundabout: function drawRoundabout() {
        ...
        cross.entranceArray.forEach(function (it) {
          ...
          var _Util$pointRotateAnge10 = interModel_Util.pointRotateAngel({
            x: x - roadWidth / 2,
            y: y + offsetY
          }, -it.angle),
              x1 = _Util$pointRotateAnge10.x,
              y1 = _Util$pointRotateAnge10.y;

          var _Util$pointRotateAnge11 = interModel_Util.pointRotateAngel({
            x: x,
            y: y
          }, -it.angle),
              x2 = _Util$pointRotateAnge11.x,
              y2 = _Util$pointRotateAnge11.y;

          var _Util$pointRotateAnge12 = interModel_Util.pointRotateAngel({
            x: x + roadWidth / 2,
            y: y + offsetY
          }, -it.angle),
              x3 = _Util$pointRotateAnge12.x,
              y3 = _Util$pointRotateAnge12.y;
    ...
    var drawRealMethods = {
      ...
      getPhaseListWithBin: function getPhaseListWithBin(moveList, movementParas) {
        ...
        cross.entranceArray.forEach(function (it, i) {
          ...
          moveList.forEach(function (itt, j) {
            ...
            if (flow && flow.enter_port_direction === it.en_id && flow.if_control && bool) {
              if (type === "phase") {
                if (Number(itt)) {
      ...
      drawWalkMan: function drawWalkMan(realInfo, movements) {
        ...
        var greyPhaseList = drawRealMethods.getTypePhaseListWithBin(realInfo.movements_state, movements, 0, "main");
        var redPhaseList = drawRealMethods.getTypePhaseListWithBin(realInfo.movements_state, movements, 1, "main");
        var yellowPhaseList = drawRealMethods.getTypePhaseListWithBin(realInfo.movements_state, movements, 2, "main");
        var greenPhaseList = drawRealMethods.getTypePhaseListWithBin(realInfo.movements_state, movements, 3, "main");
        phaseList.forEach(function (it, i) {
          ...
          if (it.includes(4)) {
            drawRealMethods.drawFootLight(manPoint[0], "green", entrance.angle, runColor);
            drawRealMethods.drawFootLight(manPoint[3], "green", entrance.angle, runColor);
          } else {
            if (it.includes(10) || it.includes(11)) {
              if (it.includes(10)) {
                // 人行1
                drawRealMethods.drawFootLight(manPoint[0], "green", entrance.angle, run1Color);
                drawRealMethods.drawFootLight(manPoint[1], "green", entrance.angle, run1Color);
              } else {
                drawRealMethods.drawFootLight(manPoint[0], "red", entrance.angle, run1Color);
                drawRealMethods.drawFootLight(manPoint[1], "red", entrance.angle, run1Color);
              }

              if (it.includes(11)) {
                // 人行2
                drawRealMethods.drawFootLight(manPoint[2], "green", entrance.angle, run2Color);
                drawRealMethods.drawFootLight(manPoint[3], "green", entrance.angle, run2Color);
              } else {
                // 人行2
                drawRealMethods.drawFootLight(manPoint[2], "red", entrance.angle, run2Color);
                drawRealMethods.drawFootLight(manPoint[3], "red", entrance.angle, run2Color);
              }
            } else {
              //红灯
              drawRealMethods.drawFootLight(manPoint[0], "red", entrance.angle, runColor);
              drawRealMethods.drawFootLight(manPoint[3], "red", entrance.angle, runColor);
            }
          }
        });
      },
      ...
      drawGreenRedLightWithType: function drawGreenRedLightWithType(realInfo, movements) {
        ...
        phaseList.forEach(function (it, i) {
          if (it.length || road_type === "main") {
            ...
            _this16.drawLightHandler(points[2], "right", angle, rightColor, xAngle); // 绘制非机动车左转


            if (redPhases.includes(12) || yellowPhases.includes(12) || greenPhases.includes(12)) {
              var nonLeftColor = _this16.getLightcolor("nonLeft", greyPhases, redPhases, yellowPhases, greenPhases);

              if (nonLeftColor) {
                _this16.drawLightHandler(points[3], "nonBack", angle, null, xAngle, road_type);

                _this16.drawLightHandler(points[3], "nonLeft", angle, nonLeftColor, xAngle);
              }
            } // 绘制非机动车直行


            if (redPhases.includes(13) || yellowPhases.includes(13) || greenPhases.includes(13)) {
              var nonCenterColor = _this16.getLightcolor("nonCenter", greyPhases, redPhases, yellowPhases, greenPhases);

              if (nonCenterColor) {
                _this16.drawLightHandler(points[4], "nonBack", angle, null, xAngle, road_type);

                _this16.drawLightHandler(points[4], "nonCenter", angle, nonCenterColor, xAngle);
              }
            }
          }
        });
      ...
      getRuncolor: function getRuncolor(type, greyPhases, redPhases, yellowPhases, greenPhases) {
        ...
        var color = state.drawOption.redColor;
      ...
      calculateEntranceLightPoint: function calculateEntranceLightPoint(drawEntrance, road_type) {
        ...
        var nonLeftPoint = [centerPoint[0] - radius * 6, centerPoint[1] - offsetHeight * (radius * 5)]; //非机动车左

        var nonCenterPoint = [centerPoint[0] - radius * 8 - margin, centerPoint[1] - offsetHeight * (radius * 8 + margin)]; //非机动车直

        points = [leftPoint, centerPoint, rightPoint, nonLeftPoint, nonCenterPoint];
      ...
      drawLightHandler: function drawLightHandler(point, drawType, angle, color) {
        ...
        if (drawType === "back") {
          ...
          _lightBack.offsetX(_lightBack.width() / 2);

          _lightBack.offsetY(_lightBack.height() / 2);

          realLayer.add(_lightBack);
        } else {
          // 红绿灯黑底
          var circle = new lib.Circle({
            x: centerPoint.x,
          ...
          if (drawType === "center") {
            ...
            var ponitInfo = getDirectionLightData({
              x: point[0],
              y: point[1]
            }, drawType);
            var point1 = ponitInfo.point1,
                point2 = ponitInfo.point2,
                polygon1 = ponitInfo.polygon1,
                polygon2 = ponitInfo.polygon2,
                polygon3 = ponitInfo.polygon3;
            var rotatePoint1 = drawMethods.getRotateData(point1, angle);
            var rotatePoint2 = drawMethods.getRotateData(point2, angle);
            var rotatePolygon1 = drawMethods.getRotateData(polygon1, angle);
            var rotatePolygon2 = drawMethods.getRotateData(polygon2, angle);
            var rotatePolygon3 = drawMethods.getRotateData(polygon3, angle); // 绘制两个圆

            var circle1 = new lib.Circle({
              x: rotatePoint1.x,
              y: -rotatePoint1.y,
              radius: CrossConst.roadWidth / 3 * 4 / 5 / 3,
              fill: color
            });
            var circle2 = new lib.Circle({
              x: rotatePoint1.x,
              y: -rotatePoint1.y,
              radius: CrossConst.roadWidth / 3 * 4 / 5 / 4,
              fill: "#000000"
            });
            var circle3 = new lib.Circle({
              x: rotatePoint2.x,
              y: -rotatePoint2.y,
              radius: CrossConst.roadWidth / 3 * 4 / 5 / 3,
              fill: color
            });
            var circle4 = new lib.Circle({
              x: rotatePoint2.x,
              y: -rotatePoint2.y,
              radius: CrossConst.roadWidth / 3 * 4 / 5 / 4,
              fill: "#000000"
            });
            var polygonShape1 = new lib.Shape({
              stroke: color,
              fill: color,
              strokeWidth: 0.2,
              sceneFunc: function sceneFunc(context, shape) {
                context.beginPath();
                rotatePolygon1.forEach(function (it, k) {
                  if (k === 0) {
                    context.moveTo(it.x, -it.y);
                  } else {
                    context.lineTo(it.x, -it.y);
            ...
            var polygonShape2 = new lib.Shape({
              stroke: color,
              fill: color,
              strokeWidth: 0.2,
              sceneFunc: function sceneFunc(context, shape) {
                context.beginPath();
                rotatePolygon2.forEach(function (it, k) {
                  if (k === 0) {
                    context.moveTo(it.x, -it.y);
                  } else {
                    context.lineTo(it.x, -it.y);
            ...
            var polygonShape3 = new lib.Shape({
              stroke: color,
              fill: color,
              strokeWidth: 0.2,
              sceneFunc: function sceneFunc(context, shape) {
                context.beginPath();
                rotatePolygon3.forEach(function (it, k) {
                  if (k === 0) {
                    context.moveTo(it.x, -it.y);
                  } else {
                    context.lineTo(it.x, -it.y);
...
// EXTERNAL MODULE: ./packages/interModel/src/interModel.vue?vue&type=style&index=0&id=53dddc24&lang=scss
var interModelvue_type_style_index_0_id_53dddc24_lang_scss = __webpack_require__("f2c8");
